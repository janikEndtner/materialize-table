...
import {MaterializeTableConfig} from "./materialize-table-config";
...
export class MaterializeTableComponent implements OnInit {
    ...
    @Input() config: MaterializeTableConfig;
    ...
    ngOnInit() {
        ...
        this.sort.sortBy = this.config.initialSortBy;
        this.sort.asc = this.config.initialSortOrderAsc;
